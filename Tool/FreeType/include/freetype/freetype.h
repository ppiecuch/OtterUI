...
#define ft_encoding_apple_roman     FT_ENCODING_APPLE_ROMAN
  ...
  /*                                                                       */
  /*    generic_data             :: A field reserved for client uses.  See the  */
...
#define FT_STYLE_FLAG_BOLD    ( 1 << 1 )
  ...
  /*                                                                       */
  /*    generic_data :: A typeless pointer, which is unused by the FreeType     */
  ...
  typedef struct  FT_SizeRec_
  {
    ...
    FT_Generic        generic_data;   /* generic_data pointer for client uses */
  ...
  /*                                                                       */
  /*    generic_data           :: A typeless pointer which is unused by the     */
...
#define ft_open_params    FT_OPEN_PARAMS     /* deprecated */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    A simple structure used to pass more or less generic_data parameters to */
  /*    @FT_Open_Face.                                                     */
  /*                                                                       */
  /* <Fields>                                                              */
