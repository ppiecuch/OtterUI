...
#define FT_COMPONENT  trace_objs
                ...
                FT_Driver  driver )
  {
    ...
    if ( size->generic_data.finalizer )
      size->generic_data.finalizer( size );
                ...
                FT_Driver  driver )
  {
    ...
    if ( face->generic_data.finalizer )
      face->generic_data.finalizer( face );
...
#define FT_COMPONENT  trace_objs
  ...
  Destroy_Module( FT_Module  module )
  {
    ...
    if ( module->generic_data.finalizer )
      module->generic_data.finalizer( module );
...
#define FREETYPE_VER_FIXED  ( ( (FT_Long)FREETYPE_MAJOR << 16 ) | \
  ...
  FT_Done_Library( FT_Library  library )
  {
    ...
    /* Discard client-data */
    if ( library->generic_data.finalizer )
      library->generic_data.finalizer( library );
